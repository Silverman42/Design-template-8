...
(function($){
    $.fn.quickSlide = function(param){
        ...
        return this.each(function(index){
            ...
            if (options.slideType === "simple") {
            ...
            else if(options.slideType === "auto"){
                var slideHide = function () {  
                    $(qsSlides).each(function (index, element) {
                        // element == this
                        $(element).css({"display":"none"}); //no display in all slides
                ...
                var animate = setInterval(slideHideAnimate, 7000);
                $(window).blur(function (e) {  
                    clearInterval(animate);
                })
                $(window).focus(function (e) {  
                    animate = setInterval(slideHideAnimate, 7000);
                })
...
$('.qs-container').quickSlide({slideType:"auto"});